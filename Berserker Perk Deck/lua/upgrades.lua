...
-------------------------------------------------- init values --------------------------------------------------	
	...
	self.values.temporary.berserker_movement = { 0.9 } --<-- Movement bonus added during Swan Song (normal Swan Song 40% movement speed, with perk deck 40% + 90% = 130% movement speed) 
