...
or string_id == "menu_deck" .. s .. "_3_desc" and "Damaging enemies increases Swan Song duration by ##0.7## second and additional ##0.05## seconds for each armor tier above 2-Piece Suit.\n##0.5## seconds cooldown\n\n(Swan Song duration can not increase above your maximum Swan Song duration.)"
...
or string_id == "menu_deck" .. s .. "_9_desc" and "You gain additional ##4## lives before going into arrest.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a PAYDAY is increased by ##10%##."
